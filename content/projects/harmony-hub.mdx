...
thumbnailUrl: '/images/projects/harmony-hub/thumbnail.png'
images: [
...
<TechStack
  ...
  technologies={[
    { name: "Web Audio API", icon: "/icons/webaudio.svg", url: "https://developer.mozilla.org/Web_Audio_API" },
    { name: "BiquadFilterNode", icon: "/icons/filter.svg", url: "https://developer.mozilla.org/en-US/docs/Web/API/BiquadFilterNode" },
    { name: "AudioContext", icon: "/icons/audiocontext.svg", url: "https://developer.mozilla.org/en-US/docs/Web/API/AudioContext" }
  ]}
/>
