...
githubUrl: ''
liveUrl: ''
thumbnailUrl: '/images/projects/ai-music-collab/thumbnail.png'
images: [
  '/images/projects/ai-music-collab/stage-model.png',
  '/images/projects/ai-music-collab/agency-model.png',
  '/images/projects/ai-music-collab/collaboration-model.png'
]
---
...
<TechStack
  ...
  technologies={[
    { name: "Case Study", icon: "/icons/case-study.svg", url: "#" },
    { name: "Semi-Structured Interviews", icon: "/icons/interview.svg", url: "#" },
    { name: "Artifact Analysis", icon: "/icons/artifact.svg", url: "#" },
    { name: "Abductive Analysis", icon: "/icons/analysis.svg", url: "#" }
  ]}
/>
...
![Human-AI Co-Creation Stage Model](/images/projects/ai-music-collab/stage-model.png)
...
![Human-AI Agency Model](/images/projects/ai-music-collab/agency-model.png)
