...
<AudioPlayer
  src="/audio/bday24-quasar.mp3"
  title="'Quasar' w/ @recyclexbin - Excerpt"
  showWaveform={true}
  accentColor="#3366CC"
/>

**Quasar w/ @recyclexbin** represents our fourth collaboration, showcasing how our production styles have evolved to complement each other. The track features contrasting sections that highlight our individual approaches while creating a cohesive whole.

<AudioPlayer
  src="/audio/bday24-staytruee.mp3"
  title="'StayTruee' w/ @recyclexbin & @april211k - Excerpt"
  showWaveform={true}
  accentColor="#CC6633"
/>

**StayTruee w/ @recyclexbin & @april211k** demonstrates the three-producer workflow we developed over multiple sessions. This track particularly stands out for its layered percussion and atmospheric elements contributed by each producer.
...
<AudioPlayer
  src="/audio/bday24-supplied.mp3"
  title="'Supplied' (Solo) - Excerpt"
  showWaveform={true}
  accentColor="#339966"
/>
...
<AudioPlayer
  src="/audio/bday24-illusions.mp3"
  title="'Illusions' (Solo) - Excerpt"
  showWaveform={true}
  accentColor="#993366"
/>
