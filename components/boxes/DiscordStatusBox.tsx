...
// Define the TypeScript interfaces for better type safety
    ...
    useEffect(() => {
        if (mainActivity && mainActivity.timestamps && mainActivity.timestamps.start) {
            const interval = setInterval(() => {
                setElapsedTime(getElapsedTime(mainActivity.timestamps.start as number));
            }, 1000);
            ...
            >
                ...
                <div className="m-3 flex flex-col h-full gap-3">
                    ...
                    <div className="text-sm h-fit px-2 py-1 rounded-lg bg-tertiary/50 leading-snug">
                        <div>{lanyard.data.discord_user.display_name || lanyard.data.discord_user.global_name || lanyard.data.discord_user.username}</div>
                    ...
                    <div className="flex h-full p-2 rounded-lg bg-tertiary/50 leading-snug gap-2 items-center">
                        {hasMainActivity ? (
                            <>
                                <div className="relative">
                                    {mainActivity.application_id && mainActivity.assets?.large_image && (
                                        <Image
                                    ...
                                    {mainActivity.application_id && mainActivity.assets?.small_image && (
                                        <Image
