// scripts/utils/bento-layouts.tsx
export const lgLayout = [
    { i: 'intro', x: 0, y: 0, w: 2, h: 1 },
    { i: 'about-ctfs', x: 2, y: 1, w: 1, h: 1 },
...
export const smLayout = [
    ...
    { i: 'image-1', x: 0, y: 2, w: 1, h: 2, static: true },
    { i: 'twitter', x: 1, y: 3, w: 1, h: 1, static: true },
    { i: 'discord', x: 0, y: 1, w: 2, h: 1, static: true },
    { i: 'spotify', x: 0, y: 4, w: 2, h: 2, static: true },
    { i: 'tech', x: 0, y: 6, w: 1, h: 3, static: true },
    { i: 'about-ctfs', x: 1, y: 6, w: 1, h: 1, static: true },
    { i: 'contributions', x: 0, y: 7, w: 2, h: 1, static: true },
]
